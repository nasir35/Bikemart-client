    ...
    <div className="bg-gray-800 py-2 p-6">
      <div className="grid md:grid-cols-3 sm:grid-cols-1 md:gap-x-2 md:gap-y-0 gap-y-3 pb-4 border-b">
        <div id="logo-and-address">
          <NavLink to="/home">
            <h2 className="text-coral text-2xl pb-2">BookMart</h2>
          </NavLink>
        ...
        <div id="useful-links" className="flex flex-col text-white">
          ...
          <NavLink to="/home" className="underline text-blue-200 px-4">
        ...
        <div className="subscribe-our-newsletetr space-y-2">
          ...
          />
          <button className="bg-green-custom rounded py-1 px-4 block text-white">
            Subscribe
          </button>
        </div>
      </div>
      <p className="text-center text-gray-300">
        &copy; All rights reserved. Nasir 2021
      </p>
    </div>
  );
};
