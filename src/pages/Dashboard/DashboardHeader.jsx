      ...
      <div className="lg:col-span-2 md:col-span-3 col-span-6 flex items-center">
        <h2>
          <FontAwesomeIcon
            ...
            icon={faBars}
            className="md:hidden text-xl text-red-500 mr-3"
          />
        </h2>
        <Link to="/dashboard">
          <h2 className="mr-5 md:text-2xl text-xl text-coral">Dashboard</h2>
        </Link>
      </div>
      <div className="lg:col-span-6 col-span-6 ">
        <h2 className="md:text-2xl text-xl md:text-left text-right font-qsand text-green-custom">
